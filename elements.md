    ...
    <div class="hero-content">
        <div class="hero-text">
            <h1 class="hero-title">
                ...
                <span class="highlight-text">Background</span>
            </h1>
            <div class="hero-subtitle">
                <span class="accent-text">Education</span>, <span class="accent-text">Experience</span> & <span class="accent-text">Skills</span>
            </div>
        </div>
        ...
        <div class="competencies-grid">
            <div class="competency-card">
                <div class="competency-icon">
                    <img src="assets/images/bank.png" alt="Economic Analysis" />
                </div>
                <h3 class="competency-title">Economic Analysis & Stress Testing</h3>
                <p class="competency-description">Macroeconomics, Risk Analsyis, Scenario Analysis, Basel, IFRS9, and Financial Indicators</p>
            </div>
            
            <div class="competency-card">
                <div class="competency-icon">
                    <img src="assets/images/programming.png" alt="Programming" />
                </div>
                <h3 class="competency-title">Programming & Scripting</h3>
                <p class="competency-description">Analysis, Research, Logic, Scientific Method, Creativity, and a Variety of Languages</p>
            </div>
            
            <div class="competency-card">
                <div class="competency-icon">
                    <img src="assets/images/stress.png" alt="Data Analytics" />
                </div>
                <h3 class="competency-title">Data Analytics & Data Mining</h3>
                <p class="competency-description">Databases, Extracts, Reporting, and Predictive Analysis</p>
            </div>
            
            <div class="competency-card">
                <div class="competency-icon">
                    <img src="assets/images/write.png" alt="Documentation" />
                </div>
                <h3 class="competency-title">Documentation, Presenting & Report Writing</h3>
                <p class="competency-description">Audience Analysis, Attention to Deail and Tracing, Evidencing Mindset</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="summary-content">
            ...
            <div class="roles-grid">
                <div class="role-card">
                    ...
                    <p class="role-description">In my role in Credit Forecasting at JP Morgan, I support the expansion of the ICB business expansion across the UK and Europe. My responsibilities included forecasting credit losses and allowance, developing analytics for new products, and collaborating with various stakeholders. I leveraged my strong analytical skills and coding expertise in Python to drive data-driven decision-making and the developement of loss forecasting models.</p>
                </div>
                ...
                <div class="role-card">
                    ...
                    <p class="role-description">During my time as a Graduate Technology Analyst at NatWest Group, I gained valuable experience in data science, product analytics, and security and fraud analysis. Working closely with senior scientists, I leveraged various Python libraries and utilized tools like SAS, SQL, and Tableau for effective data visualization. I also contributed to fraud prevention efforts by researching and writing educational papers.</p>
                </div>
            </div>
        </div>
    </div>
...
<section id="resume" class="resume-section">
    <div class="section-container">
        ...
        <div class="resume-subsection">
            ...
            <div class="education-card">
                <div class="education-logo">
                    <img src="{% link assets/images/uom_seal.png %}" alt="University of Manchester" />
                </div>
                <div class="education-content">
                    <h4 class="education-institution">University of Manchester</h4>
                    <p class="education-details">Materials Science & Engineering, 2017 Graduation<br>Courses & Achievments: Superalloys & High Performance Materials, Advanced Metals Processing, Metallurgy of Engineering Alloys, Advanced Nuclear Materials, Composite & Advanced Materials. Written a first-class thesis on metal oxide thermoelectrics</p>
                </div>
            </div>
        </div>
            ...
            <div class="work-experience-container">
                    ...
                    <div class="experience-header">
                        <div class="company-info">
                            ...
                            <div class="position-details">
                                ...
                                <p class="position-location">London, UK<br>September 2024 – Current</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="experience-header">
                        <div class="company-info">
                            ...
                            <div class="position-details">
                                ...
                                <p class="position-location">London, UK<br>December 2022 – August 2024</p>
                            </div>
                        </div>
                    </div>
                    <div class="experience-content">
                    ...
                    <div class="experience-header">
                        <div class="company-info">
                            ...
                            <div class="position-details">
                                ...
                                <p class="position-location">London, UK<br>September 2019 – November 2022</p>
                            </div>
                        </div>
                    </div>
                    <div class="experience-content">
                    ...
                    <div class="experience-header">
                        <div class="company-info">
                            ...
                            <div class="position-details">
                                ...
                                <p class="position-location">London, UK<br>September 2018 – September 2019</p>
                            </div>
                        </div>
                    </div>
                    <div class="experience-content">
                ...
                <div class="experience-item">
                    <div class="experience-header">
                        <div class="company-info">
                            <div class="company-logo">
                                <img src="assets/images/Coutts_old.svg" alt="Coutts Logo" />
                            </div>
                            <div class="position-details">
                                <h4 class="position-title">NatWest Holdings | Coutts | Product Analytics</h4>
                                <p class="position-location">London, UK<br>September 2017 – September 2018</p>
                            </div>
                        </div>
                    </div>
                    <div class="experience-content">
        ...
        <div class="resume-subsection">
            ...
            <div class="projects-grid-resume">
                <div class="project-card-resume">
                    <div class="project-image-resume">
                        <img src="{% link assets/images/PITCH IQ PRIMARY.png%}" alt="Pitch IQ" />
                    </div>
                    <div class="project-content-resume">
