...
<div class="row">
	<div class="4u 12u$(medium)">
		...
		<p>As a Quantitative Stress Testing Analyst at NatWest Group, I dive deep into portfolios and conduct benchmarking analysis using Python, advanced Excel, and SQL. I present credit risk stress testing results to senior management, create well-structured documentation, and develop automated reporting dashboards. My focus is on identifying key drivers and communicating business implications for NatWest Group.</p>
	</div>
	<div class="4u 12u$(medium)">
		<h3>Graduate Technology Analyst</h3>
...
<div class="box">
	...
	<div class="6u 12u$(small)">
		...
		<p>London, UK<br> 
		December 2022 – Current</p>
	</div>
	<div class="6u$ 12u$(small)">
		<ul>
		<li>Providing review and challenge of stress testing results including portfolio deep dive and bench-marking analysis, using advanced python, advanced excel and SQL for the Retail franchise arms of NatWest Group</li>
		<li>Presenting credit risk stress testing results to senior management and business stakeholders, focusing onkey drivers of results and business implications.</li>
		<li>Coverage includes:  Banking book models, PD,LGD,EAD models and ICAAP, EBA and PRA stress tests.
</li>
		</ul>
	</div>
	...
	<div class="6u$ 12u$(small)">
		<ul>
		<li>Developing automated methods in python to validate both retail and wholesale credit stress testing models as well as executing top-down credit risk stress testing result</li>
		...
		<li>Creating automated reporting dashboards to be used by multiple users for analysing, understanding, andreporting stress test outcomes, using both Python, Excel and Tableau.</li>
		</ul>
	</div>
	<!-- #3 -->
	<div class="6u 12u$(small)">
	...
	<div class="6u$ 12u$(small)">
		<ul>
			<li>Assisted with the delivery of experiments and worked with senior scientists and data engineers in buildingfunctional machine learning models</li>
			<li>Gained experience working with various python libraries, including; pandas,numpy and sci kit learn.</li>
		</ul>
	</div>
	<!-- #4 -->
	<div class="6u 12u$(small)">
	...
	<div class="6u$ 12u$(small)">
		<ul>
			...
			<li>Main projects included; customer segmentation analysis, competitoranalysis, as well as performing ad-hoc data queries for various teams in the private bank</li>
		</ul>
	</div>
...
<h2 id="content">Projects</h2>
	...
	<div class="box">
		...
		<ul class="actions"> <a href="'https://pitchiq800.substack.com/p/cannon-iq'" class="button">View Project</a></ul>
	</div>
	</div>
<div class="6u 12u$(small)">
	<div class="box">
